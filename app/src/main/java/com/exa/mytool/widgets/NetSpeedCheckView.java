...
/**
 * Created by lzy on 2023/5/17
 * Description：网络测试仪表盘
 */
public class NetSpeedCheckView extends View {
    ...
    private static final int DEAFAULT_COLOR_TITLE = Color.WHITE;//标题颜色
    ...
    private static final int DEAFAULT_TITLE_SIZE = 28;//标题大小
    ...
    public NetSpeedCheckView(Context context) {
        this(context, null);
    }

    public NetSpeedCheckView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NetSpeedCheckView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        titleTextEnable = attributes.getBoolean(R.styleable.ClockView_text_title_enable, true); //是否绘制标题文本
    }
