...
public class SongAnimUtils {
    ...
    public SongAnimUtils(Context context) {
    ...
    public void addGoodsToCart(TextView goodsImg, final View startView, final View endView) {
        ...
        ConstraintLayout parent = (ConstraintLayout) goodsImg.getParent();
        if (parent != null) {
    ...
    private void initAnim() {
        ...
        float startX = startLoc[0] - parentLocation[0] - goodsImg.getWidth() / 4;
        float startY = startLoc[1] - parentLocation[1] - goodsImg.getHeight() / 4;
