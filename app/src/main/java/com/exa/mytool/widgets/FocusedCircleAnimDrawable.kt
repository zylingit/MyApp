 ...
 * 焦点光圈动画，显示为圆形
 */
class FocusedCircleAnimDrawable: Drawable() {

    private val TAG = "FocusedCircleAnimDrawable"
...
//                    Log.d("AnimDrawable", "onAnimationRepeat: reverse")
    ...
    override fun setBounds(left: Int, top: Int, right: Int, bottom: Int) {
        ...
        path.reset()
        path.addOval(RectF(bounds.left.toFloat() + lineWidth,
            bounds.top.toFloat() + lineWidth,
            bounds.right.toFloat() - lineWidth,
            bounds.bottom.toFloat() - lineWidth), Path.Direction.CW)
