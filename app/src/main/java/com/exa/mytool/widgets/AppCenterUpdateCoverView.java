 ...
 * 应用中心-应用更新 图片view
 */
public class AppCenterUpdateCoverView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public AppCenterUpdateCoverView(Context context) {
        super(context);
        init(context, null);
    }

    public AppCenterUpdateCoverView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void initSizes(int width, int height) {
        ...
        mInitOuterCircleRadius = 90f / 200 * size;

        if (mInnerCircleRadius == -1) {

            mInnerCircleRadius = 80f / 200 * size;
        }
